package me.humboldt123.sky.reset

import me.humboldt123.sky.Sky
import me.humboldt123.sky.util.clearFully
...
object ResetSequence {
    ...
    fun run(plugin: Sky) {
        ...
        if (lobby == null) {
            plugin.logger.warning("lobby-spawn not set! Use /sky set lobby-spawn")
            Bukkit.broadcast(net.kyori.adventure.text.Component.text("§c[Sky] lobby-spawn not configured!"))
            return
        }
