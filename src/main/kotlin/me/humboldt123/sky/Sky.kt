package me.humboldt123.sky

import me.humboldt123.sky.abilities.AbilityListener
import me.humboldt123.sky.abilities.BombermanManager
import me.humboldt123.sky.abilities.CooldownManager
import me.humboldt123.sky.abilities.ItemCooldownManager
import me.humboldt123.sky.abilities.NecromancerManager
import me.humboldt123.sky.abilities.ShieldManager
import me.humboldt123.sky.commands.*
import me.humboldt123.sky.config.ConfigManager
import me.humboldt123.sky.interactables.InteractableListener
import me.humboldt123.sky.interactables.InteractableManager
import me.humboldt123.sky.interactables.PondPortalTask
import me.humboldt123.sky.interactables.SnakeBlockTask
import me.humboldt123.sky.interactables.SwitchListener
import me.humboldt123.sky.kit.KitManager
import me.humboldt123.sky.listeners.CombatListener
import me.humboldt123.sky.listeners.PlayerListener
import me.humboldt123.sky.shop.ShopManager
...
class Sky : JavaPlugin() {
    ...
    override fun onEnable() {
        ...
        val cryptCmd = SkyAdminCommand(this)
        getCommand("sky")?.setExecutor(cryptCmd)
        getCommand("sky")?.tabCompleter = cryptCmd
        ...
        getCommand("kits")?.setExecutor(CommandExecutor { sender, _, _, _ ->
            ...
            if (sender.gameMode != org.bukkit.GameMode.CREATIVE && kitManager.hasUsedKitsThisRound(sender)) {
                sender.sendMessage("§cYou already selected a kit this round! Ask an admin for /sky kit giveuse")
